...
- (void)setPlaceholder:(NSString *)string {
	...
	if ([self isFirstResponder] && self.typingAttributes) {
        ...
        // pat: corrected color, so that it is the same than the placeholder of a UITextField
		attributes[NSForegroundColorAttributeName] = [UIColor colorWithRed:199.0/255 green:199.0/255 blue:205.0/255 alpha:1.0];
